...
CREATE TABLE `employes` (
  ...
  `sexe` enum('m','f') NOT NULL COMMENT 'genre employés',
  `service` varchar(30) DEFAULT NULL COMMENT 'service des l''employés',
  `date_embauche` date DEFAULT NULL COMMENT 'date embauche employés',
...
(991, 'jeanne', 'lolilol', 'f', 'production', '2021-12-02', 2150),
(993, 'lala', 'poto', 'f', 'commercial', '2021-12-02', 2000);
...
--
ALTER TABLE `employes`
  MODIFY `id_employes` int(3) NOT NULL AUTO_INCREMENT COMMENT 'id de la table PK AI', AUTO_INCREMENT=994;
COMMIT;
